...
class TestAccountAccess:
    ...
    def test_access_to_account_by_header_button(self, driver):
        ...
        WebDriverWait(driver, 3).until(expected_conditions.element_to_be_clickable((Locators.ORDERS_HISTORY)))
        assert driver.find_element(*Locators.ORDERS_HISTORY).is_displayed() == True
